...
for datettt in ('17','20','21','22','23','24','27','28','29'):
        
    InputputPath = dirpath +'\\Output\\' + '2020' + datettt + '04'
    tempmktcutoff = pd.read_excel(InputputPath +'\\DMEM_MarketCutoff_' + '2020' + datettt + '04.xlsx', sheet_name='DMEM_MarketCutoff')
    tempmktcutoff['datettt'] = '2020' + '04' + datettt    
    
    tempmonitor = pd.read_excel(InputputPath +'\\DMEM_OutputMonitor_' + '2020' + datettt + '04.xlsx', sheet_name='DMEM_OutputMonitor_')
    tempmonitor['datettt'] = '2020' + '04' + datettt
...
CleanAllMonitor = CleanAllMonitor.merge(AllMonitor.iloc[:,1:14], how='left', on='msci_security_code')
