...
#####################
"""
bbo = BBODownload(sDate = '2020-07-07', eDate = '2020-07-07', region='world').get()

InputPath = 'C:\\Users\\mabboud\\PycharmProjects\\Python\\MSCI_QIR\\input\\'
CalcDate='07/07/2020'
IntCalcDate = '07/08/2020'
...
DMSTDPath = 'P:\\daily\\2020\\07\\'
EMSTDPath = 'S:\\daily\\2020\\07\\'
DMSMLPath = 'Q:\\daily\\2020\\07\\'
EMSMLPath = 'T:\\daily\\2020\\07\\'
...
InputPathCCS= (InputPath + '0604d_36.59_.rif')
...
"""
#####################
# Basic Investability Adjusted for QIR
#####################
"""
...
GIEU_SecurityData = All_SecurityData.loc[(All_SecurityData['Status']=='STD') | (All_SecurityData['Status']=='SML') | (All_SecurityData['Status']=='STD_SHADOW')]
GIEU_CompanyData = All_CompanyData.loc[(All_CompanyData['Status']=='STD') | (All_CompanyData['Status']=='SML') | (All_CompanyData['Status']=='STD_SHADOW')]
